                ...
                <div class="card-header py-3 ">
                    <div class="row">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <a class="btn btn-icon btn-sm btn-outline-primary mr-1" href="{{ route('koordinatorValidasiPekerjaan') }}"><i
                                class="fas fa-arrow-left mr-1"></i> Kembali</a>
                                <!-- {{dump($guestLand)}} -->
                                @if ($guestLand->peta_bidang)
                                <button type="button" class="btn btn-icon btn-info btn-sm mr 2" data-toggle="modal" data-target="#peta_bidang">
                            ...
                            @if ($guestLand->status_proses == 4)
                                <form
                                    ...
                                    @csrf
                                    <button type="submit" class="btn btn-icon btn-sm btn-primary ml-1" id="status_proses"
                                        name="status_proses" value="{{ $guestLand->status_proses + 1 }}"><i
                                            class="fas fa-check mr-1"></i>Terima Pekerjaan</button>
                                    <button type="button" class="btn btn-icon btn-sm btn-danger mx-1" data-toggle="modal" data-target="#restore">
