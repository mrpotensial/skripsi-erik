            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-12 d-flex justify-content-end">
                    <div class="my-5 d-flex">
                        ...
                        <form class="mx-3 d-flex"
                            action="{{ route('adminPembuatanPetaUpdate', ['id' => $guestLand->id]) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="date" id="batas_waktu_pekerjaan" name="batas_waktu_pekerjaan"
                                class="form-control">
                            <button type="submit" class="btn btn-primary ml-1" id="status_proses" name="status_proses"
                                value="{{ $guestLand->status_proses + 1 }}"><i class="fas fa-check"></i></button>

                            <button type="submit" class="btn btn-danger ml-1" id="status_proses" name="status_proses"
                                value="{{ $guestLand->status_proses - 1 }}"><i class="fas fa-trash"></i></button>
                        </form>
                    </div>
                </div>
            </div>
